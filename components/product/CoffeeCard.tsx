  ...
  return (
    <div className="group flex cursor-pointer flex-col overflow-hidden rounded-xl border border-amber-100/50 bg-white transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl">
      ...
      <div className="flex flex-1 flex-col p-4 sm:p-5 lg:p-6">
        ...
        <p className="mt-1 flex-1 text-[11px] sm:text-xs leading-relaxed text-black line-clamp-2 sm:line-clamp-3">
          {coffee.description}
        </p>

        <div className="mt-3 sm:mt-4 flex items-center justify-between">
          <span className="rounded-full border border-gray-300 px-2 sm:px-3 py-0.5 sm:py-1 text-[9px] sm:text-[10px] font-medium text-black transition-colors group-hover:border-amber-200 group-hover:text-amber-700">
            {coffee.type}
          </span>
          <span className="flex items-center gap-1 text-[10px] sm:text-xs text-black">
