...
import { PRIVACY_SECTIONS } from "@/data/privacy-sections";
import SectionCard from "@/components/privacy-policy/SectionCard";
import NavButton from "@/components/privacy-policy/NavButton";
        ...
        <div className="max-w-5xl mx-auto pt-8 sm:pt-10 pb-2 sm:pb-8 relative">
          <div className="flex flex-col-reverse sm:flex-row sm:items-start sm:justify-between gap-4 px-4 sm:px-6 md:px-10">
            <div className="min-w-0">
              ...
              <p className="mt-2 text-[13px] leading-6 sm:text-sm text-stone-800">
                Sahwa Coffee — how we handle your information
              </p>
            </div>
          ...
          <p className="text-[13px] leading-6 sm:text-sm text-stone-800 mt-3 px-4 sm:px-6 md:px-10">
            We collect only what's needed to respond to you and run the export
            process. We don't sell it, and you can ask us to delete it.
          </p>
        </div>
      </header>
