export default function MissionStatement() {
  return (
    <section className="relative bg-cream overflow-hidden font-montserrat">
      <div className="relative max-w-7xl mx-auto px-8 sm:px-10 md:px-12 lg:px-14 py-20 sm:py-28 md:py-20">
        <div className="text-center">
          ...
          {/* Mission statement */}
          <h2 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold leading-relaxed sm:leading-relaxed text-stone-900 mx-auto">
